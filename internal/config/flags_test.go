...
func TestValidatePasses(t *testing.T) {
	cfg := Config{InputDir:"in",OutputDir:"out",TmpDir:"tmp",LogsDir:"logs",Jobs:1,ThreadsPerJob:1,AVSineMode:"lock",MetadataFullMode:"clean_diversify",
		...
		FreezeCount:EventCountRange{0,2}, ReplaceCount:EventCountRange{0,2}, PixelReplacePercent:PercentRange{0,1}, PixelReplaceMode:"edge", PixelAreaEdgeInset:PercentRange{0,1}, NeighborOffsetMin:0, NeighborOffsetMax:1,
	}
